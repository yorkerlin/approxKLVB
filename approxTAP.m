function [alpha, sW, L, nlZ, dnlZ] = approxTAP(hyper, covfunc, lik, x, y)
...
eta = 5e-2; tol = 1e-5; max_sweep = 5000;       % learning rate, fault tolerance
